...
print("Target 1 count:", code.count(target1))
...
print("Target 2 count:", code.count(target2))
...
print("Target 3 count:", code.count(target3))
...
print("Target 4 count:", code.count(target4))
...
print("Target 5 count:", code.count(target5))
...
print("Target 6 count:", code.count(target6))
